...
impl Component for Chat {
    ...
    fn view(&self, ctx: &Context<Self>) -> Html {
        ...
        html! {
            <div class="flex w-screen bg-gradient-to-b from-gray-900 to-black">
                <div class="flex-none w-56 h-screen bg-gradient-to-b from-gray-900 to-black">
                    ...
                    <div class="w-full grow overflow-auto border-b-2 border-gray-700">
                        {
                            self.messages.iter().enumerate().map(|(index, m)| {
                                ...
                                html!{
                                    <div class="flex items-end w-3/6 bg-gray-800 m-8 rounded-tl-lg rounded-tr-lg rounded-br-lg chat-bubble" style={format!("animation-delay: {}", animation_delay)}>
